...
class HydraulicModel : 
    ...
    def stepEulerForward(self,k = 0): 
        ...
        See , Se1e = (285* self.CommandePompe['PMP01']) ,(285* self.CommandePompe['PMP02'])
        ...
        self.Y['CANTK1'].append(162*self.Ct1state/At1)
        self.Y['CAPTK1'].append(Ct1e)
        self.Y['CANTK2'].append(162*self.Ct2state/At2)
...
if __name__ == '__main__' :     
    ...
    plt.plot(model.Temps, model.Y['CANTK1'], 'y', label='Niveau')
    # Ajout d'une légende
    plt.legend()
