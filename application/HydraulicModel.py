...
class HydraulicModel : 
    ...
    def stepEulerForward(self,k = 0): 
        ...
        Rv1r,Rv2r = (50 * (1-self.CommandeVanne['VLV01'])),(50*(1-self.CommandeVanne['VLV02']))
        Rv3r,Rv4r = (50 *(1-self.CommandeVanne['VLV03'])),(50 *(1-self.CommandeVanne['VLV04']))
        Rv5r,Rv6r = (50 *(1-self.CommandeVanne['VLV05'])),(50 *(1-self.CommandeVanne['VLV06']))
        Rv7r,Rv8r = (50 *(1-self.CommandeVanne['VLV07'])),(50 *(1-self.CommandeVanne['VLV08']))
        Rv9r,Rv10r = (50 *(1-self.CommandeVanne['VLV09'])),(50 *(1-self.CommandeVanne['VLV10']))
